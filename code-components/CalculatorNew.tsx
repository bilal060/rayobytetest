    ...
    <div className={`${className}`}>
      <form className="calculator-form new-calculator" onSubmit={(e) => e.preventDefault()}>
        ...
        <div className='part3'>
          ...
          {/* <p className='question'>7. Copy relevant info from the other side of the worksheet:</p> */}
          {/* <div className="calculate-row">
            <div className='new-two-fields responsive'>
              <div className="calculator-inputbox withlabel">
                <span>Current proxy costs:</span>
                <div>
                  <input
                    className="proxy-input text-lightBlue"
                    readOnly
                    value={isNaN(unitPurchased * perUnitPrice) ? 0 : unitPurchased * perUnitPrice}
                  />
              ...
              <div className="calculator-inputbox withlabel">
                <span>Current GB consumption:</span>
                <div>
                  <input
                    className="proxy-input text-lightBlue"
                    readOnly
                    value={isNaN(gbDataScrapPerMonth) ? 0 : gbDataScrapPerMonth}
                  />
                  <label>Answer to question 2a</label>
                </div>
              </div>
            </div>
          </div> */}
